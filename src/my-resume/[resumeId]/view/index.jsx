...
function ViewResume() {
  ...
  const GetResumeInfo = useCallback(() => {
    LocalStorageApi.GetResumeById(resumeId)
      .then((resp) => {
      ...
      .catch((error) => {
        ...
        toast.error(
          "Resume not found. Please check the URL or create a new resume."
        );
      ...
      <div id="no-print">
        ...
        <div className="my-10 mx-10 md:mx-20 lg:mx-36">
          <div className="flex flex-wrap justify-center gap-4 px-4 md:px-44 my-10">
            ...
            <RWebShare
              data={{
                text: `Check out ${resumeInfo?.firstName || "this amazing"} ${
                  resumeInfo?.lastName || "professional"
                }'s resume!`,
